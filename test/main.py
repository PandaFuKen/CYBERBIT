...
# Lambda para salir del juego
salir_juego = lambda: (pygame.quit(), sys.exit())

# Lambda para verificar si la opción es válida
es_opcion_valida = lambda opcion: opcion is not None

# Lambdas para imprimir selecciones
imprimir_personaje = lambda personaje: print(f"Personaje seleccionado: {personaje}")
imprimir_nivel = lambda nivel: print(f"Nivel seleccionado: {nivel}")
...
imprimir_personaje(personaje_seleccionado)
...
imprimir_nivel(nivel_seleccionado)
